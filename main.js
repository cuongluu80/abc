...
var WeatherService = /** @class */ (function () {
    function WeatherService(http) {
        this.http = http;
        this.apiKey = '5b3f542009def8355c6df3dd92bccb81';
    }
    WeatherService.prototype.getCityWeatherByName = function (city, metric) {
        ...
        this.http.get("https://api.openweathermap.org/data/2.5/weather?q=" + city + "&units=" + metric + "&APPID=" + this.apiKey)
    ...
    WeatherService.prototype.getCitiesWeathersByNames = function (cities, metric) {
        ...
        cities.forEach(function (city) {
            citiesSubject.next(_this.http.get("https://api.openweathermap.org/data/2.5/weather?q=" + city + "&units=" + metric + "&APPID=" + _this.apiKey));
        });
    ...
    WeatherService.prototype.getMaxTemp = function (city, metric) {
        ...
        var dataSubject = new rxjs__WEBPACK_IMPORTED_MODULE_2__["Subject"]();
        var max;
        this.http.get("https://api.openweathermap.org/data/2.5/forecast?q=" + city + "&units=" + metric + "&APPID=" + this.apiKey)
            .subscribe(function (weather) {
    ...
    WeatherService.prototype.getMinTemp = function (city, metric) {
        ...
        var dataSubject = new rxjs__WEBPACK_IMPORTED_MODULE_2__["Subject"]();
        var min;
        this.http.get("https://api.openweathermap.org/data/2.5/forecast?q=" + city + "&units=" + metric + "&APPID=5b3f542009def8355c6df3dd92bccb81")
            .subscribe(function (weather) {
...
var WeatherCardComponent = /** @class */ (function () {
    ...
    WeatherCardComponent.prototype.ngOnInit = function () {
        ...
        this.weather.getCurrentTemp(this.city).subscribe(function (data) {
            _this.currentTemp = data;
        });
        this.weather.getMinTemp(this.city).subscribe(function (data) {
            _this.minTemp = data;
        });
        this.weather.getMaxTemp(this.city).subscribe(function (data) {
            _this.maxTemp = data;
        });
    };
    ...
    ], WeatherCardComponent.prototype, "city", void 0);
...
module.exports = __webpack_require__(/*! D:\CYBERSOFT\_SAMPLE\minimus-master\src\main.ts */"./src/main.ts");
